...
import {
    getProfileById, updateProfileById, updatePassword
} from "../../api";
...
export default function ProfilePageForAdmin() {
    ...
    const fetchData = async () => {
        await getProfileById(userId).then(
            res => {
    ...
    const handleUpdateProfile = async () => {
        ...
        await updateProfileById(avatarFile, updateData, userId).then(
            res => {
                loadInitialData(res.data);
